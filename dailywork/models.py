...
class Contact(models.Model):
    ...
    address = models.CharField(max_length=20, verbose_name='办公地点')
    ...
    status = models.CharField(max_length=10, default='在职', verbose_name='状态')
    ...
    class Meta:
        ...
        unique_together = ('department', 'name', 'phone')
