...
def updateERPDepreciateDate():
    ...
    for ds in dataSets.values():
        ...
        cost = ds['cost']  # 成本
        ds['remainder_month'], ds['cost'], ds['remainder_value'], ds['remainder_count'], ds['residual_value'], ds[
            'month_depreciate'], ds['year_depreciate'], ds['accumulate_depreciate'] = reCalculateERPCost(1,
                                                                                                         depreciateDate,
                                                                                                         limitYear,
                                                                                                         cost)
